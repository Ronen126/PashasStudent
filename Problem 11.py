...
def ProductDiagonalRight():
    currentdiagonalproduct = 1
    finaldiagonalproduct = 1
    for r in xrange(17):
        for c in xrange(17):
            for i in xrange(4):
            ...
            currentdiagonalproduct = 1
    return finaldiagonalproduct

def ProductDiagonalLeft():
    currentdiagonalproduct = 1
    finaldiagonalproduct = 1
    for r in xrange(17):
...
def main():
    number = 0
    finallist = [ProductDiagonalRight(),ProductDiagonalLeft(),ProductUpDown(),ProductLeftRight()]
    for i in finallist:
        if number < i:
            number = i
    return number
